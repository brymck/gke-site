...
func init() {
	proto.RegisterType((*GreetingRequest)(nil), "optodemo.GreetingRequest")
	proto.RegisterType((*Greeting)(nil), "optodemo.Greeting")
}
...
var fileDescriptor_ca53982754088a9d = []byte{
	...
	0xd7, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0xc8, 0x2f, 0x28, 0xc9, 0x07, 0xf1, 0x95, 0x54,
	0xb9, 0xf8, 0xdd, 0x8b, 0x52, 0x53, 0x4b, 0x32, 0xf3, 0xd2, 0x83, 0x52, 0x0b, 0x4b, 0x53, 0x8b,
	0x4b, 0x84, 0x84, 0xb8, 0x58, 0xf2, 0x12, 0x73, 0x53, 0x25, 0x18, 0x15, 0x18, 0x35, 0x38, 0x83,
	0xc0, 0x6c, 0x25, 0x15, 0x2e, 0x0e, 0x98, 0x32, 0x21, 0x09, 0x2e, 0xf6, 0xdc, 0xd4, 0xe2, 0xe2,
	0xc4, 0x74, 0x98, 0x12, 0x18, 0xd7, 0xc8, 0x8f, 0x8b, 0xc7, 0x23, 0x35, 0x27, 0x27, 0x3f, 0x38,
	0xb5, 0xa8, 0x2c, 0x33, 0x39, 0x55, 0xc8, 0x8e, 0x8b, 0xdb, 0x3d, 0xb5, 0x04, 0xae, 0x51, 0x52,
	0x0f, 0x66, 0xad, 0x1e, 0x9a, 0x9d, 0x52, 0x42, 0x98, 0x52, 0x4a, 0x0c, 0x49, 0x6c, 0x60, 0xd7,
	0x1a, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x85, 0x75, 0xe1, 0x93, 0xbb, 0x00, 0x00, 0x00,
}
...
func (c *helloServiceClient) GetGreeting(ctx context.Context, in *GreetingRequest, opts ...grpc.CallOption) (*Greeting, error) {
	out := new(Greeting)
	err := c.cc.Invoke(ctx, "/optodemo.HelloService/GetGreeting", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HelloService_GetGreeting_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/optodemo.HelloService/GetGreeting",
	}
...
var _HelloService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "optodemo.HelloService",
